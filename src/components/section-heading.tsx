...
export function SectionHeading({
  ...
  return (
    <div className={`min-w-0 w-full max-w-full ${alignment}`}>
      ...
      <h2 className="max-w-full text-3xl font-bold leading-tight break-words text-[var(--color-midnight-ink)] sm:text-5xl">
        {title}
      </h2>
